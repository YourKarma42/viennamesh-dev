...
namespace viennamesh
{
    ...
    namespace result_of
    {
        ...
        struct data_information<cgal::polyhedron_surface_mesh>
        {
            ...
            {
                return "cgal::polyhedron_surface_mesh";
            }
            static viennamesh_data_make_function make_function()
            {
                return viennamesh::generic_make<cgal::polyhedron_surface_mesh>;
            }
            static viennamesh_data_delete_function delete_function()
            {
                return viennamesh::generic_delete<cgal::polyhedron_surface_mesh>;
            }
        };
    }
