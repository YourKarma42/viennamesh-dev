...
namespace Surface_mesh_simplification  
{
  ...
  template<class ECM_>
class Curvature_curved_placement
{
public:
...
public:
  ...
  Curvature_curved_placement(viennamesh::cgal::cgal_mesh_analytics<ECM>  & a, LindstromTurk_params const& aParams = LindstromTurk_params()) 
